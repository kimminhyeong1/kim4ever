...
.toggle--label {width: 115px;height: 41px; right: -270px; margin-top:59px; background: var(--blue-color);border-radius: 100px;display: flex;position: relative;transition: all 350ms ease-in;}
