...
#content table th {width:100px; padding:10px; text-align:left;  border: 1px solid #ddd; background: #ff9933;}
...
#content table td { white-space: pre-line;  word-wrap:break-word;}
...
#content table {width:80%; height:auto; border-collapse:collapse; margin: auto; font-size:14px; font-family: 'omyu_pretty' ; }
