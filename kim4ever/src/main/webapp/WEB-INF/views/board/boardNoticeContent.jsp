...
#main #content h2{text-align:left; margin-top:10px; margin-left:10%; font-size:18px; margin-bottom:10px;}
#main #bottom{width:auto; height:10px;}
#content table {width:80%; height:auto; border-collapse:collapse; margin: auto; font-size:14px; }
#content table th {width:30px; padding:2px; text-align:left; b}
...
#content #btn button{width:50px; height:25px; margin:0 auto; text-align:center; font-family: 'omyu_pretty'; font-size:14px; border-radius:20px; }
