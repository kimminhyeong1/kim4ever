...
<html>
	<head>
		...
		<style type="text/css">
			...
			/*사진첩 헤더*/   
			.albumHeader {display:flex;align-items:center;justify-content:space-between;border:1px solid #000; border-radius:10px;width:100%;height:80px;padding:0 20px;}
