...
public class AdminController {
	...
	public HashMap<String, Object> adminrentalshopRegisterNameCheck(
	...
	public String adminrentalshopRegisterAction(@RequestParam("rentalshopName") String rentalshopName, // 대여소 이름
...
////////////////	 		게시글 관리			///////////////// 	
	...
	public String adminboardList(SearchCriteria scri, Model model) {
		...
		int totalCount = bs.boardTotal2(scri);
		pm.setScri(scri);
		pm.setTotalCount(totalCount);
