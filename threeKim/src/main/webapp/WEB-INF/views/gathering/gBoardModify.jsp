...
<html>
	...
	<body>
		...
		<main id="main">
			<form action="${pageContext.request.contextPath}/gathering/gBoardModifyAction.do" method="POST">
				...
				<section class="gContainer gSetContainer">
					<div>
						...
						<div>
							...
							<input class="gInput" type="text" name="gBoardTitle" placeholder="내용을 입력해주세요" value="${gbv.gBoardTitle}">											
						</div>
						<div>
							<h3>게시글 내용</h3>
							<textarea rows="5" cols="5" name="gBoardContents" placeholder="글자제한:500자이내">${gbv.gBoardContents}</textarea>		
						</div>
					</div><!-- 끝-->
					<div>
