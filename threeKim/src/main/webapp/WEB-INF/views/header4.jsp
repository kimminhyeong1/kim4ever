...
=======
	...
	<div id="menu">		
		...
		<p onclick="location.href='<%=request.getContextPath()%>/admin/bikeList.do'">자전거 관리</p>
		<p onclick="location.href='<%=request.getContextPath()%>/admin/rentalshopList.do'">대여소 관리</p>
