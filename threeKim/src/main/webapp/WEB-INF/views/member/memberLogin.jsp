...
<html>
	...
	<script src="https://t1.kakaocdn.net/kakao_js_sdk/2.2.0/kakao.min.js"integrity="sha384-x+WG2i7pOR+oWb6O5GV5f1KN2Ko6N7PTGPS7UlasYWNxZMKQA63Cj/B2lbUmUfuC" crossorigin="anonymous"></script><!-- 카카오 스크립트 -->
	<script>
  ...
  function loginWithKakao() {
    Kakao.Auth.authorize({
      redirectUri: 'http://localhost:8080/${pageContext.request.contextPath}/member/login/oauth2/code/kakao.do',
    });
  }
